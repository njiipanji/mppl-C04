...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2017 at 12:22 AM
...
CREATE TABLE `ceklis` (
  ...
  `ceklis_waktu` datetime DEFAULT NULL,
...
(1, 1, 1, 0, NULL, NULL, NULL, NULL, NULL);
...
(5, 'Panji', '2017-05-14 18:54:43', 'Panji Rimawan');
...
(1, '5114100016', 'Humaira', 'biar pinter', 0, 1),
(2, '5114100009', 'Andi Ersaldy', 'Ingin menambah ilmu', 1, 2);
...
(1, '5114100116', '5114100116', '5114100116', 'pemandu', NULL, NULL, NULL),
(2, '5115100116', '5115100116', '5115100116', 'oc', NULL, NULL, NULL),
(3, '5116100116', '5116100116', '5116100116', 'calon', NULL, NULL, NULL),
(4, '5116100117', '5116100117', '5116100117', 'calon', NULL, NULL, NULL);
...
--
ALTER TABLE `hari`
  MODIFY `hari_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `kuesioner_jawab`
  MODIFY `kuesioner_jawab_id` int(11) NOT NULL AUTO_INCREMENT;
--
